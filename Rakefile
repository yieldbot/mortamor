...
desc 'Retrieve the current version of mortamor'
task :version do
  puts Mortamor::Version.json_version
end

desc 'Bump the PATCH version of Mortamor'
task :bump do
  version_file = 'lib/mortamor/version.rb'
